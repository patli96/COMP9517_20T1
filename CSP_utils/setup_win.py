...
PATH = 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community\\VC\\Tools\\MSVC\\14.16.27023\\bin\\Hostx64\\x64' + ';' + os.environ.get(
    'PATH')
...
ext_modules = [
    ...
    Extension('keras_csp.nms.gpu_nms',
              ['keras_csp/nms/nms_kernel.cu', 'keras_csp/nms/gpu_nms.cpp'],
